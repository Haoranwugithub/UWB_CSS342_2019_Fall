...
### 4. (5pt) Write a unit test in ***test/unit_tests.cpp*** for your merge(SortedSingleLinkedList &) in task 3 to verify it works correctly. The cases in the examples above all need to be verified in your test. One point for each case.
